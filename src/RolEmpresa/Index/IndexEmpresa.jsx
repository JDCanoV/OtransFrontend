...
import Header from '../../Header/HeaderEmpresa'; // Importa el componente Header
import GoogleMapComponent from '../../Components/googlemaps/GoogleMapComponent'; // Importa el componente para mostrar el mapa
import '../../HomePage/Home.css'; // Importa el archivo de estilos CSS
...
export default IndexEmpresa; // Exporta el componente Home
